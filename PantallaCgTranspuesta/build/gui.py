...
from src.Operaciones_Mat.TransponerMatriz import Transponer_matriz_excel
...
RutaMatrizTranspuesta = Matrices/"MatrizFinal.xlsx"
ImagenNumericaTranspuesta =  RutaNav/"imagenes"/"matricesimgs"/"ImagenNumFinal.png"
...
def GenerarMatricesNumericas():
    global mapeo_color_transposicion
    ...
    mapeo_color_transposicion = mapeo_color
    print(f"Matriz numérica de transpuesta generada en: {ruta_salida_imagen_numerica}")
...
def EjecutarTransposicion():
    ...
    def procesar():
            try:
                ...
                MatrizTranspuesta = Transponer_matriz_excel(MatrizOriginal,RutaMatrizTranspuesta)
                CrearImagenesFinales(
                        MatrizTranspuesta,
                        ImagenNumericaTranspuesta, 
                        ImagenTranspuesta,
...
button_1 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda:  EjecutarTransposicion(),
    relief="flat"
)
button_1.place(
    x=4.0,
